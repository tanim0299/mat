...
<div class="page-content fade-in-up">
   ...
   <div class="card">
    <div class="card-header">
        <b>@lang('category.edit_title')</b>
    </div>
    <div class="card-body">
        <form method="post" action="{{ route('category.update',$data['data']->id) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <select class="form-control form-control-sm js-example-basic-single" name="item_id" id="item_id">
                        ...
                        <option
                        @if($data['data']->item_id == $i->id) selected @endif
                        value="{{ $i->id }}">
                ...
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <input type="text" class="form-control form-control-sm @error('category_name') is-invalid @enderror" id="category_name" name="category_name" value="{{ $data['data']->category_name }}">
                    @error('category_name')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-6">
                    ...
                    <input type="text" class="form-control form-control-sm" id="category_name_bn" name="category_name_bn" value="{{ $data['data']->category_name_bn }}">
                </div>
